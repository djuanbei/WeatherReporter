...
public class WeatherAlertService extends Service {
    ...
    protected WeatherRecord loadRecord(String zip) {
        return YWeatherFetcher.getMockRecord();
    ...
    private void notifyFromHandler(String location, String zip) {
        ...
        Notification.Builder builder = new Notification.Builder(this)
                ...
                .setSmallIcon(R.drawable.severe_weather_24)
                .setContentTitle("Severe Weather Alert!");

       // final  Notification n=new Notification.Builder(this).setContentTitle("Severe Weather Alert!").setContentText(location).build();

        final Notification n = builder.build();

        //        new Notification(R.drawable.severe_weather_24, "Severe Weather Alert!", System
         //   .currentTimeMillis());
